...
- **`LibraryViewModel`** (`ViewModels/LibraryViewModel.swift`) — the track library. Holds
  ...
  load. The VM→VM reference is deliberate — it's the library↔playback bridge; services stay clean.
