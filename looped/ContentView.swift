...
struct ContentView: View {
    @StateObject private var audioPlayer = AudioEngineController()
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            // MARK: - Speed / Pitch Sliders
            VStack {
                Text("Playback Speed: \(String(format: "%.2fx", audioPlayer.rate))")
                Slider(value: $audioPlayer.rate, in: 0.5...2.0, step: 0.01) { _ in
